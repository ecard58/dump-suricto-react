...
const Membro = ({ nome, cargo, imgSrc, redesSociais }) => {
  return (
    <div className="col-12 col-sm-6 col-md-4 col-lg-3">
      <div className="nossa-equipe">
        <div className="foto">
          <img className="img-fluid" src={imgSrc} alt={nome} />
        </div>
        ...
        <ul className="redes-sociais">
          {redesSociais.map((redeSocial, index) => (
            <li key={index}>
              <a href={redeSocial.url} aria-hidden="true">
                {" "}
                {redeSocial.icon} <p>GITHUB</p>
              </a>
            </li>
          ))}
        </ul>
...
const Contatos = () => {
  const membrosEquipe = [
    {
      nome: "Lucas Gonzaga",
      cargo: "Vascaino e Residente TIC",
      imgSrc:
        "https://uploaddeimagens.com.br/images/004/658/428/full/lucas.png?1699384360",
      redesSociais: [
        {
          icon: (
            <svg
          ...
          url: "https://github.com/olucasgon",
        },
      ],
    },
    {
      nome: "Bruno Lima",
      cargo: "Residente TIC",
      imgSrc: "https://avatars.githubusercontent.com/u/111309780?v=4",
      redesSociais: [
        {
          icon: (
            <svg
          ...
          url: "https://github.com/brunolimaptr",
        },
      ],
    },
    {
      nome: "Emanuel Cardoso",
      cargo: "Professor e Residente em TIC",
      imgSrc:
        "https://uploaddeimagens.com.br/images/004/658/431/full/manu.png?1699384426",
      redesSociais: [
        {
          icon: (
            <svg
          ...
          url: "https://github.com/ecard58",
        },
      ],
    },
    {
      nome: "Beatriz Barcelos",
      cargo: "Residente TIC",
      imgSrc: "https://avatars.githubusercontent.com/u/113399889?v=4",
      redesSociais: [
        {
          icon: (
            <svg
          ...
          url: "https://github.com/beabarcel",
        },
      ],
    },
    {
      ...
      cargo: "Residente TIC",
      imgSrc:
        "https://uploaddeimagens.com.br/images/004/658/447/full/aurelio.jpg?1699385024",
      redesSociais: [
        {
          icon: (
            <svg
          ...
          url: "https://github.com/netolamela",
        },
      ],
    },
    {
      nome: "Mahyara Paraquett",
      cargo: "Aspirante de moda e Residente TIC",
      imgSrc:
        "https://uploaddeimagens.com.br/images/004/658/426/full/mahyara.jpg?1699384253",
      redesSociais: [
        {
          icon: (
            <svg
          ...
          url: "https://github.com/MahyParaquett",
        },
      ],
    },
  ];
